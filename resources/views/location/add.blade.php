                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('storelocation',['event'=>$event]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="attendee" type="number" min="2" class="form-control @error('attendee') is-invalid @enderror" name="attendee" value="{{ old('attendee')?old('attendee'):2}}" autocomplete="attendee">
